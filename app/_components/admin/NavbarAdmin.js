...
const NavbarAdmin = () => {
  ...
  const breadcrumb = (path) => {
    if (path === "/admin") {
      ...
      return "User";
    } else if (path === "/admin/gejala") {
      return "Gejala";
    } else if (path === "/admin/diagnosa") {
      return "Diagnosa";
    } else if (path === "/admin/hasil") {
      return "Hasil";
    } else {
      return "";
    }
        ...
        <nav>
          ...
          <ol class="flex flex-wrap pt-1 mr-12 bg-transparent rounded-lg sm:mr-16">
            <li class="text-sm leading-normal">
              <Link class="text-black opacity-50" href="/admin">
                Admin
              </Link>
            </li>
            <li
          ...
          <h6 class="mb-0 font-bold text-black capitalize">
            {breadcrumb(path)}
          </h6>
        </nav>
        ...
        <div class="flex items-center mt-2 grow sm:mt-0 sm:mr-6 md:mr-0 lg:flex lg:basis-auto">
          ...
          <a class="inline-block px-8 py-2 mb-0 mr-4 text-xs font-bold text-center text-blue-500 uppercase align-middle transition-all ease-in bg-transparent border border-blue-500 border-solid rounded-lg shadow-none cursor-pointer leading-pro hover:-translate-y-px active:shadow-xs hover:border-blue-500 active:bg-blue-500 active:hover:text-blue-500 hover:text-blue-500 tracking-tight-rem hover:bg-transparent hover:opacity-75 hover:shadow-none active:text-black active:hover:bg-transparent" target="_blank" href="https://www.creative-tim.com/builder/soft-ui?ref=navbar-dashboard&amp;_ga=2.76518741.1192788655.1647724933-1242940210.1644448053">Online Builder</a>
            ...
            <li class="relative flex items-center pr-2">
              ...
              <Link
                href="javascript:;"
                class="block p-0 text-sm text-black transition-all ease-nav-brand"
                aria-expanded="false"
              >
              ...
              >
                  ...
                  >
                    <div class="flex py-1">
                      ...
                      <div class="flex flex-col justify-center">
                        <h6 class="mb-1 text-sm font-normal leading-normal dark:text-black">
                ...
                <li class="relative">
                  ...
                  >
                    <div class="flex py-1">
                      <div class="inline-flex items-center justify-center my-auto mr-4 text-sm text-black transition-all duration-200 ease-nav-brand bg-gradient-to-tl from-slate-600 to-slate-300 h-9 w-9 rounded-xl">
                        <svg
                          width="12px"
                          height="12px"
                          viewBox="0 0 43 36"
