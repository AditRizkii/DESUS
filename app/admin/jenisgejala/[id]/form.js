    ...
    <form onSubmit={handleSubmit} className="w-full max-w-4xl mb-4">
      <div className="md:flex md:items-center mb-6">
        ...
        <div className="w-9/12">
          <input
            className="bg-gray-100 h-20 text-start appearance-none border-2 border-gray-100 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500"
            id="nama"
            name="nama"
            type="text"
